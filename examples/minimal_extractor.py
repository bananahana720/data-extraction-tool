"""
Minimal example extractor demonstrating the foundation interfaces.

This shows how to implement BaseExtractor using the core data models.
Use this as a template for real format extractors (DOCX, PDF, etc.).
"""
