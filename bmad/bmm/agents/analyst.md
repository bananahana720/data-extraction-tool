...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*brainstorm-project" workflow="{project-root}/{bmad_folder}/bmm/workflows/1-analysis/brainstorm-project/workflow.yaml">Guide me through Brainstorming</item>
    <item cmd="*product-brief" workflow="{project-root}/{bmad_folder}/bmm/workflows/1-analysis/product-brief/workflow.yaml">Produce Project Brief</item>
