...
Status: ready-for-dev (Epic 3.5 - Bridge Epic)

## Dev Agent Record
- **Context Reference:** docs/stories/3-5-2-claude-md-lessons-section.context.xml
...
- [ ] Document "Do" patterns with examples:
  ...
  - Bridge epics for preparation (Epic 2.5 → Epic 3)
