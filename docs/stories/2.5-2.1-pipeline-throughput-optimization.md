...
- `tests/performance/test_throughput.py` - Updated tests to use 4-worker parallelization, updated baselines
- `docs/stories/2.5-2.1-pipeline-throughput-optimization.md` - Documented implementation and results
