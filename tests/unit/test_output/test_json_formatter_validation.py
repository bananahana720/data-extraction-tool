"""Unit tests for JsonFormatter validation and edge cases (Story 3.4).

Tests pretty-printing, edge cases handling, and schema validation.
...
Part 3 of 3: Validation, formatting, and edge cases.
"""
...
@pytest.fixture
def sample_chunks(sample_enriched_chunk):
